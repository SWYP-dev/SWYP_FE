...
// Figma Header 컴포넌트(node 24:3480) 스펙 반영.
// ⚠️ SearchInput의 placeholder 14px/padding-y 12px라고 되어있었으나
//    현재 Figma 값(12px/4px)엔 아직 미반영. 확인 필요
  ...
  return (
    <header className="flex w-full flex-col items-end justify-center border-b border-line-secondary bg-base-white px-12 py-6">
      <form
        ...
        className="flex w-[237px] items-center overflow-hidden rounded-max border border-line-secondary bg-base-white px-6 py-2"
      >
        <div className="flex min-h-6 flex-1 items-center justify-between">
          <input
            ...
            className="flex-1 bg-transparent text-1 text-label-base placeholder:text-label-placeholder outline-none"
          />
